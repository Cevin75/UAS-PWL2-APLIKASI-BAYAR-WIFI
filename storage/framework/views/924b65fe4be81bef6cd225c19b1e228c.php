...
<div class="container-fluid d-flex flex-column justify-content-between" style="min-height: 100vh;">
    <div class="d-flex flex-column gap-2 pt-2">
        <div class="col d-flex flex-row justify-content-between gap-4">
            ...
            <h4 class="text-center" style="background: white; border-radius:16px; padding: 4px; width: 100%"><?php echo e(__('pulsa.pulsa')); ?></h4>
        ...
        <div class="d-flex flex-column justify-content-between m-4 p-4">
            <form method="POST" action="<?php echo e(route('buat-transaksi')); ?>">
                ...
                <div class="d-flex flex-column gap-1">
                    <label for="telp" class="block text-sm font-medium text-gray-600"><?php echo e(__('pulsa.telp')); ?></label>
                    <input type="text" name="telp" class="mt-1 p-2 block w-full border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-300" required />
                    <input type="hidden" name="jenis" class="mt-1 p-2 block w-full border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-300" value="pulsa" />
                </div>
                <div class="d-flex flex-column gap-1">
                    <label for="nominal" class="block text-sm font-medium text-gray-600"><?php echo e(__('pulsa.credit')); ?></label>
                    <select id="nominal" name="nominal" class="mt-1 p-2 block w-full border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-300">
                        <option value="25000">25000</option>
                        <option value="50000">50000</option>
                        <option value="75000">75000</option>
                    </select>
                </div>
                <button type="submit" style="width: 100%;" class="mt-4"><?php echo e(__('pulsa.pay')); ?></button>
            </form>
        </div>
...
<?php echo $__env->make('app.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aplikasi-bayar\resources\views/app/service/pulsa.blade.php ENDPATH**/ ?>